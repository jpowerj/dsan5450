...
* A random variable $Y_i$ representing whether or not an individual $i$ was arrested (where we use $Y$ here to represent an **outcome** that we're hoping to **explain**)

## Part 5: Doin Thangs (Causality)
