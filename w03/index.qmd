...
## Where Descriptive and Normative Intertwine (Whether You Want It To Or Not :O)

* Allowing this **asymmetry** is precisely what enables bring **descriptive** facts to bear on **normative** concerns: **mathematically** we can swap the mapping into $\{0, 1\}$, but this (again, in a precise, logical sense) implies that we're treating **racial treatment** as the same type of phenomenon as **driving on left or right side of road** (see: prev slides on why we make the descriptive vs. normative distinction)
