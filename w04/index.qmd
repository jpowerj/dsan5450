...
## Contemporary Example: Palestine {.text-68 .crunch-quarto-layout-panel .crunch-title .crunch-ul .crunch-blockquote .crunch-li .crunch-p}
...
## Better Metaphor Than Letters {.smaller .crunch-title .title-11 .crunch-ul .crunch-math .crunch-quarto-figure}
...
* Better metaphor: **UDC** (2yr school) rule for **allocating** [**basketball tickets**](https://www.udcfirebirds.com/sports/mbkb/index):

$$
\text{Seniors} \prec \text{Juniors}
$$

* $\Rightarrow$ If you're a Senior, whether at "top" or "bottom" of a <span data-bracket="(Judges)">ranking of Seniors</span>, you still (by Constitution) have **priority** over all Juniors...
...
## Implications for "Fair" AI? {.crunch-title .title-09 .crunch-ul}
...
## Psychological Synthesis: Two-Level Utilitarianism {.text-90 .title-09 .crunch-title .crunch-quarto-layout-panel .crunch-quarto-figure .crunch-images .crunch-figcaption}
