...
<tr>
    ...
    <td><span data-qmd="{{< var w01.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td>2</td>
    <td><span data-qmd="{{< var w02.date-md >}}"></span></td>
    <td><span data-qmd="{{< var w02.title >}}"></span></td>
</tr>
<tr class="new-unit">
    <td><span data-qmd="**Unit 2**: Fairness"></span></td>
    <td>3</td>
    <td><span data-qmd="{{< var w03.date-md >}}"></span></td>
    <td><span data-qmd="{{< var w03.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td>4</td>
    <td><span data-qmd="{{< var w04.date-md >}}"></span></td>
    <td><span data-qmd="{{< var w04.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td></td>
...
<tr>
    ...
    <td><span data-qmd="{{< var w05.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td>6</td>
    <td><span data-qmd="{{< var w06.date-md >}}"></span></td>
    <td><span data-qmd="{{<var w06.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td></td>
    <td><span data-qmd="*Feb 26 (Monday), 11:59pm EST*"></span></td>
    <td><span data-qmd="*[Deliverable] HW2: Context-Sensitive Fairness*"></span></td>
</tr>
<tr>
    <td></td>
    <td>7</td>
    <td><span data-qmd="{{< var w07.date-md >}}"></span></td>
    <td><span data-qmd="{{< var w07.title >}}"></span></td>
</tr>
<tr>
    <td></td>
    <td></td>
...
| HW2: Context-Sensitive Fairness | Monday, **February 26** | 10% |
