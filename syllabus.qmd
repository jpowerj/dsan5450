...
The course meets on **Wednesdays from 3:30-6pm in the <a href='https://maps.app.goo.gl/fVVfDFpp4MEuukXa9' target='_blank'>Walsh Building</a>, Room 498**

## Course Staff

* Prof. Jeff Jacobs, <a href='mailto:jj1088@georgetown.edu' target='_blank'>`jj1088@georgetown.edu`</a>
  * Office hours (Click to schedule): <a href='https://jjacobs.me/meet' target='_blank'>Tuesdays, 3-6pm</a>
* TA Marie Vaughan, <a href='mailto:mev71@georgetown.edu' target='_blank'>`mev71@georgetown.edu`</a>
  * Office hours: TBD
* TA Sam Sofman, <a href='mailto:sbs106@georgetown.edu' target='_blank'>`sbs106@georgetown.edu`</a>
  * Office hours: TBD
...
<tr>
    ...
    <td><span data-qmd="*[Deliverable] <a href='{{< var hw3.url >}}' target='_blank'>HW3: {{< var hw3.title >}}</a>*"></span></td>
</tr>
<tr>
    <td></td>
    <td>13</td>
