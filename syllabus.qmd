...
* TA Ellie Byrd, [`eb1481@georgetown.edu`](mailto:eb1481@georgetown.edu)
...
* Catherine D'Ignazio and Lauren F. Klein (2020). [*Data Feminism*](https://data-feminism.mitpress.mit.edu/). Cambridge, MA: MIT Press. [Free, open-source!]
...
* Anne L. Washington (2023). [*Ethical Data Science: Prediction in the Public Interest*](https://annewashington.com/book-ethical-data-science-prediction-in-the-public-interest/). New York, NY: Oxford University Press.
...
<tr class='new-unit'>
    <td><span data-qmd="**Unit 3:** Privacy Policies and Data Externalities"></span></td>
    <td>8</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="We start this unit by *framing* privacy policies as contracts, as a simplifying assumption. Across judicial systems, however, there are nuances in terms of how different courts might interpret different 'pieces' of a privacy policy as legally-binding. These nuances are covered in incredibly-helpful depth in @hartzog_privacy_2026!"></div></td>
</tr>
<tr class='td-nb'>
    <td></td>
    <td>9</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="1. On the *legal* background for data externalities: @maccarthy_new_2015 (Especially pgs. 423-470)
1. The specific *economic model* of data externalities we'll look at: @acemoglu_too_2022 (only Sections 1-3 and Appendix B-3)"></div></td>
</tr>
<tr class='new-unit td-nb'>
    <td><span data-qmd="**Unit 4:** Policy Evaluation and Inverse Fairness"></span></td>
    <td>10</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="On the three basic 'policy structures' we'll use to capture what kinds of policy interventions may be necessary: @bowles_microeconomics_2009, pgs. 23-55"></div></td>
</tr>
<tr class='td-nb'>
    <td></td>
    <td>11</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="On the role of bargaining power in determining policy choice when the Pareto frontier has been reached: @bowles_microeconomics_2009, pgs. 167-183"></div></td>
</tr>
<tr class='td-nb'>
    <td class='td-nb'></td>
    <td class='td-nb'>12</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="1. *Social Welfare Functionals (SWFs)*, the tool we're adding to our toolkit this week to evaluate policies along the Pareto frontier at an *aggregate* level (as opposed to the game-theoretic models from last week, which model how interacting *individuals* might reach or fail to reach certain Pareto-optimal outcomes), are discussed in exactly the detail you'll need in @adler_measuring_2019: Chapter 4 starts to get pretty in-the-weeds, so Chapters 1-3 (which are also shorter) are more than enough!
1. The core paper you'll look at in HW4, which utilizes ML (Causal Random Forests) to derive *SWF weights* from the algorithmically-determined choices made by Mexico's PROGRESA program, is @bjorkegren_what_2025 (An earlier version, @bjorkegren_machine_2022, has more details on the ML-based estimation)"></div></td>
</tr>
<tr class='new-unit td-nb'>
    <td><span data-qmd="**Unit 5**: Discourse Ethics and Identity Formation"></span></td>
    <td>13</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="As we move into this unit on 'applications' of the frameworks we've learned throughout the course to various social issues, a crucial paper which we'll unpack first and foremost is @hu_what_2023"></div></td>
</tr>
<tr class='td-nb'>
    <td></td>
    <td>14</td>
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="1. There are many theoretical/historical overviews of liberal vs. republican conceptions of liberty [@pettit_republican_2008; @skinner_liberty_1998], and [fewer] applied works exploring how these might relate to AI and data collection [@hamilton_digital_2025].
2. For a book which does *both* (lays out the tenets of republican liberty while exploring its applications to technology-focused power struggles), my recommendation is @gourevitch_slavery_2015! Given its focus on 19th century labor activism, it may not seem *explicitly* relevant at first, but read it with the [Jacquard loom](https://en.wikipedia.org/wiki/Jacquard_machine) analogy from Week 1 in mind and the connection should be clear!
3. Chapters 6 through 10 of @acemoglu_power_2023 also focus on how imbalances of economic power impact technological development in general and AI in particular"></div></td>
</tr>
<tr>
    <td></td>
    <td></td>
...
| <a href='{{< var hw2.url >}}' target='_blank'>HW2: {{< var hw2.title >}} <i class='bi bi-box-arrow-up-right ps-1'></i></a> | {{< var hw2.date-full >}} | 9% |
| In-Class Midterm | Wednesday, **February 25** | 25% |
| <a href='{{< var hw3.url >}}' target='_blank'>HW3: {{< var hw3.title >}} <i class='bi bi-box-arrow-up-right ps-1'></i></a> | {{< var hw3.date-full >}} | 9% |
| HW4: {{< var hw4.title >}} | {{< var hw4.date-full >}} | 9% |
| HW5: {{< var hw5.title >}} | {{< var hw5.date-full >}} | 9% |
| [Policy Whitepaper](./final.qmd) | Friday, **May 8** | 30% |
