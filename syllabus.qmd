...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="1. On the three basic 'policy structures' we'll use to capture what kinds of policy interventions may be necessary: @bowles_microeconomics_2009, pgs. 23-55
1. On the *legal* background for data externalities: @maccarthy_new_2015 (Especially pgs. 423-470)
...
<tr>
  <td></td>
  <td colspan="3" class='text-85' style='padding-top: 0px;'><div data-qmd="1. On the role of bargaining power in determining policy choice when the Pareto frontier has been reached: @bowles_microeconomics_2009, pgs. 167-183
1. The paper utilizing ML (Causal Random Forests) to derive *welfare weights* from the algorithmically-determined choices made by Mexico's PROGRESA program: @bjorkegren_what_2025 (Though an earlier version, @bjorkegren_machine_2022, has more details on the ML-based estimation)"></div></td>
</tr>
<tr>
    <td></td>
    <td>11</td>
