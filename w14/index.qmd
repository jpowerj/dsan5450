...
## Operationalizing "Slavemaster": $\frac{\mathcal{P}(A)}{\mathcal{P}(B)} \rightarrow \infty$ {.smaller .crunch-title .title-10 .crunch-blockquote}

> [What is] right, as the world goes, is only in question between **equals in power**; otherwise, the strong do as they please and the weak suffer what they must. [@thucydides_war_2013 c. 411 BC]

* Can we develop **policy interventions** that **equalize power**, so that **normative** ethics ("what is right") is relevant?
* **Definition of power** ($\leadsto$ "effectiveness" of policy intervention) depends on **antecedents**, which have changed from Thucydides ("ancient") to present ("modern") [@constant_liberty_1819]
  * "Modern" definition: Focus on **equilibria** (no injustice if bad thing doesn't happen in equilibrium)
  * "Ancient" definition: Also take **off-equilibrium** possibilities into account (no injustice if bad thing doesn't happen in equilibrium **and** doesn't happen if one player deviates "on a whim") [@jacobs_operationalizing_2026 😉🤑]
* Prisoners' Dilemma 😫 $\overset{(?)}{\prec}$ Prisoners' Dilemma with *Contracting* 🤨 $\prec$ Invisible Hand Game 🥳
...
<tr>
  <th></th>
  <th align="center"><span class='honk-honk'>"liberal"</span></th>
