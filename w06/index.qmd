...
# Recap / Eureka Moment (for Midterm Prep Purposes) {.not-title-slide .title-10 data-stack-name="Midterm Things"}
...
# Blasting Off Into Causality! {.title-10 .not-title-slide data-stack-name="Causality"}
...
## The Emergence of Order {.crunch-title .crunch-quarto-layout-panel}
...
* Indochinese Genocide Draft: Why can't we just study [men who join the military] versus [men who don't], and take the difference as a causal estimate?

## For Now: *Matching* {.crunch-title .crunch-ul}
...
## Do-Calculus! Starting with DGP {.crunch-title .crunch-ul}
